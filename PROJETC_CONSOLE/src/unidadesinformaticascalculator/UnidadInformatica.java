package unidadesinformaticascalculator;

public class UnidadInformatica {
    ...
    public static void main(String[] args) {
        ...
        cantidad = (int)(Math.random()*4099+1);
        UnidadesInformaticas ui4 = new UnidadesInformaticas (opcioni, cantidad);
        ui4.mostrar();
    }
    }
}
